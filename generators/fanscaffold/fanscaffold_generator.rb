class FanscaffoldGenerator < Rails::Generator::NamedBase
  ...
  def manifest
	...
	def fanscaffold_views
      ...
      m.template('style.sass', 'public/stylesheets/sass/fanscaffold.sass')
  ...
  protected
    ...
    def banner
      "Usage: #{$0} fanscaffold ModelName [field:type, field:type]"
    end
